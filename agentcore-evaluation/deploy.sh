...
INDEX_BUDGET_SECONDS="${INDEX_BUDGET_SECONDS:-180}"
INDEX_MAX_ATTEMPTS="${INDEX_MAX_ATTEMPTS:-5}"
...
PARAMS=(
  ...
  "IndexBudgetSeconds=${INDEX_BUDGET_SECONDS}"
  "IndexMaxAttempts=${INDEX_MAX_ATTEMPTS}"
